...
// 					console.log('Requesting tile normally', tileUrl);
	...
	seed: function(bbox, minZoom, maxZoom) {
		...
		for (var z = minZoom; z<maxZoom; z++) {
			...
			var northEastPoint = this._map.project(BBOXNE,z);
			var southWestPoint = this._map.project(BBOXSW,z);
            
            /*var northEastPoint = this.map.getBounds(bbox._northEast);
			var southWestPoint = this.map.getBounds(bbox._southWest);*/
